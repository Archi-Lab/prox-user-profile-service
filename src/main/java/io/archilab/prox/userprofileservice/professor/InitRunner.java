...
public class InitRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Professor karsch = new Professor(uuid,new PersonName("Stefan Karsch"), new ProfessorTitle("Prof."),
                ...
                new ProfessorSprechzeiten("Montags 10:00-10:30"),new ProfessorBildSrc("https://google.de"), new PersonAboutMe("Hallo."));
        ...
        Professor koehler = new Professor(uuid,new PersonName("Lutz Koehler"), new ProfessorTitle("Prof."),
                ...
                new ProfessorSprechzeiten("Montags 10:00-10:30"),new ProfessorBildSrc("https://google.de"), new PersonAboutMe("Hallo, mein Name ist Lutz Köhler."));
