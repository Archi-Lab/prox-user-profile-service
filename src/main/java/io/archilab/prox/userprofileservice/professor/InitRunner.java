...
public class InitRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Professor karsch = new Professor(uuid,new PersonName("Stefan Karsch"), new ProfessorTitle("Professor Doktor"),
        ...
        Professor koehler = new Professor(uuid,new PersonName("Lutz Koehler"), new ProfessorTitle("Prof. Dr."),
                new ProfessorAdresse("Steinmüller"), new ProfessorStrasse("SteinmüllerStraße"), new ProfessorPlz("12345"),
        ...
        Professor bente = new Professor(uuid,new PersonName("Stefan Bente"), new ProfessorTitle("Prof. Dr."),
                new ProfessorAdresse("Steinmüller"), new ProfessorStrasse("SteinmüllerStraße"), new ProfessorPlz("12345"),
